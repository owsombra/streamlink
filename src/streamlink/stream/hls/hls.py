...
from requests.exceptions import ChunkedEncodingError, ConnectionError, ContentDecodingError, InvalidSchema, HTTPError # noqa: A004
...
class HLSStream(HTTPStream):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.first_segment_timestamp: int | None = None
